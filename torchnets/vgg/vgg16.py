...
class VGG16(nn.Module):
    def __init__(self, in_channels, n_classes, data_shape):
        ...
        self.conv_8 = nn.Conv2d(256, 512, 3, padding=1)
        self.conv_9 = nn.Conv2d(512, 512, 3, padding=1)
        ...
        self.dense_1 = nn.Linear(512 * torch.prod(data_shape), 4096)
